...
//--------------------------------------------TRAER DATOS--------------------------------------------//
	...
	public static function TraerTodasLasEncuestas()
	{
		...
		$consulta->execute();
		$arrProductos= $consulta->fetchAll(PDO::FETCH_CLASS, "encuesta");
		return $arrProductos;
	}
	...
	public static function TraerEncuestasDeCliente($oferta)
	{
		...
		$consulta->execute();
		$arrProducto= $consulta->fetchAll(PDO::FETCH_CLASS, "encuesta");
		return $arrProducto;
	}
...
//--------------------------------------------ALTA-BAJA-MODIFICACION--------------------------------------------//
	...
	public static function AgregarEncuesta($encuesta)
	{
		...
		$consulta->bindValue(':id_operacion',$encuesta->id_operacion, PDO::PARAM_STR);
